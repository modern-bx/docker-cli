...
Данные PostgreSQL для GlitchTip хранятся в `data/glitchtip-postgres` системного каталога compose. Поэтому база
остаётся на хосте при пересоздании контейнера и доступна для резервного копирования вместе с остальными
системными данными.
