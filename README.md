...
Таблицы MySQL без первичного ключа или не на InnoDB автоматически исключаются из первоначального snapshot: DBTrail
продолжает работать с остальными таблицами проекта без изменения схемы, но история исключённых таблиц недоступна.
