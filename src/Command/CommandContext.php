...
final class CommandContext
{
    ...
    public function __construct(private readonly ?string $transportFile = null)
    {
    }
    ...
    public function addNotification(string $origin, string $class, string $level, string $message): void
    {
