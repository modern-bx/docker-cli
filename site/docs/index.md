...
- Системный compose-стек с Traefik, dnsdock, Dockhand, MySQL, PostgreSQL, Adminer, Mailpit, GlitchTip и OpenResty.
...
Для работы с копиями данных смотрите [руководство по бэкапам](./guide/backups.md), для пользовательских хуков — [руководство по хукам](./guide/hooks.md), а краткий обзор новых возможностей собран в [последних изменениях](./guide/recent-changes.md).
