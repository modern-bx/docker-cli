...
#[AsCommand(name: 'start', description: 'Start the shared docker-cli network and system services.')]
final class StartCommand extends Command
{
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        return $this->runDockerCompose($compose->dockerComposeCommand('up'), ['-d'], $output);
    }
