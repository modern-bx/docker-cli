...
final readonly class QueueController
{
    ...
    {
        $data = $this->queues->logs($request->page, $request->pageSize, $request->sort, $request->direction, $request->project, $request->queueItem, $request->itemCode, $request->taskCode);
