...
final readonly class ResponseEmitter
{
    ...
    public function emit(object $dto): ResponseInterface
    {
        ...
        if ($dto instanceof AuthResponseDto) {
            return $response->withHeader(
                "Set-Cookie",
                JwtTokenService::COOKIE .
                    "=" .
                    rawurlencode($dto->token) .
                    "; Max-Age=" .
                    $dto->expiresIn .
        ...
        return $dto instanceof LogoutResponseDto
            ? $response->withHeader(
                "Set-Cookie",
                JwtTokenService::COOKIE . "=; Max-Age=0; Path=/; Secure; HttpOnly; SameSite=Strict",
            )
            : $response;
    }
    ...
    private function file(FileResponseDto $dto): ResponseInterface
    {
        ...
        $file =
            $this->assetsDirectory . DIRECTORY_SEPARATOR . str_replace("/", DIRECTORY_SEPARATOR, $dto->relativePath);
