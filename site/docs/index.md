...
- Системный compose-стек с Traefik, dnsdock, Dockge, MySQL, PostgreSQL, Adminer и OpenResty.
...
После запуска Dockge будет доступен по адресу `https://dockge.<ваш-домен>`, а Adminer — по адресу `https://adminer.<ваш-домен>`.
