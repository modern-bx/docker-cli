...
final readonly class ProjectOptionsDto implements \JsonSerializable
{
     ...
     * $languageVersions @param array<string, list<ConceptDto>> $frameworks @param list<DeploymentScriptDto>
     * $deploymentScripts
     */
    public function __construct(
        public array $locations,
        public array $databaseLocations,
        public array $languages,
        public array $languageVersions,
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            "defaultLanguageVersion" => $this->defaultLanguageVersion,
            "frameworks" => $this->frameworks,
            "deploymentScripts" => $this->deploymentScripts,
        ];
    }
}
