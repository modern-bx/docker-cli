...
final readonly class HookListDto implements \JsonSerializable {
    /**
     * @param list<array{id: string, level: string, command: string, timing: string, enabled: bool, hook: string}>
     * $hooks
     */
    ...
    /**
     * @return array{hooks: list<array{id: string, level: string, command: string, timing: string, enabled: bool, hook:
