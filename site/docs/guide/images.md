...
Во все PHP-FPM-образы предустановлен Composer. Глобальные пакеты Composer устанавливаются от имени
пользователя `docker-cli` при первом использовании соответствующего инструмента.
